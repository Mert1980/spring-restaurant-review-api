...
public class ReviewRequestDto {
    ...
    @Range(min = 1, max = 5, message = "Batroom quality can't be less than 1 or more than 5.")
    private int batroomQuality;

    @NotNull(message = "Staff field can't be empty.")
    @Range(min = 1, max = 5, message = "Staff can't be less than 1 or more than 5.")
    private int staff;

    @NotNull(message = "Cleanliness field can't be empty.")
    @Range(min = 1, max = 5, message = "Cleanliness can't be less than 1 or more than 5.")
    private int cleanliness;

    @NotNull(message = "Drive thru field can't be empty.")
    @Range(min = 1, max = 5, message = "Drive thru can't be less than 1 or more than 5.")
    private int driveThru;

    @NotNull(message = "Delivery speed field can't be empty.")
    @Range(min = 1, max = 5, message = "Delivery speed can't be less than 1 or more than 5.")
